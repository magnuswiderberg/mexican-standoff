...
public sealed record PlayerSnapshot(string Id, string Name, int Hp, int Bullets, int Gold, bool IsAlive);
...
public sealed record LobbyPlayer(string Id, string Name);
